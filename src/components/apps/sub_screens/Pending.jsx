...
const Pending = ({ handleView }) => {
  ...
  const [filterPendingApplication, setFilterPendingApplication] = useState([]);
  ...
  useEffect(() => {
    setFilterPendingApplication(handleSearch(applications, searchValue));
      ...
      >
        <Box>
          <Table
            ...
            // }}
            columns={columns}
            dataSource={filterPendingApplication}
          />
        </Box>
      </ConfigProvider>
    </>
